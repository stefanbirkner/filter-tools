...
public class PostFilterChainActionsFilterTest {
    ...
    private final Filter filter = new PostFilterChainActionsFilter(firstAction, secondAction);

    /* You must copy the tests from ActionsFilterTest if PostFilterChainActionsFilter doesn't extend ActionsFilter
     * anymore .
     */

    @Test
    public void executesActionsAfterInvokingFilterChain() throws Exception {
